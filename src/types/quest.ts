...
export const QUESTS: Omit<Quest, "completed" | "starsEarned">[] = [
  ...
  {
    id: "right-click", title: "마우스 우클릭", description: "마우스 오른쪽 버튼을 눌러보세요!",
  ...
  },
  {
    ...
    hint: "바탕화면 빈 곳에서 오른쪽 버튼 → 새로 만들기 → 폴더!", termKey: "folder",
  },
  {
  ...
  },
  {
    ...
    instruction: "글자 크기를 '20'으로 변경하세요!",
